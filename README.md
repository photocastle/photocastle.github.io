...
This repository uses the **Docsy** theme
...
```bash
git clone --recurse-submodules --depth 1 https://github.com/photocastle/photocastle.github.io.git
```
...
container, the container runs with a volume bound to the this
